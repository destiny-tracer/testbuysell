/**
 * App Loan Calculator
 * Calculates EMI for app-based loans (short-term loans).
 */

export const appLoanCalc = {
  id: 'app-loan',
  name: 'App Loan Calculator',
  description: 'Calculate EMI for app-based short-term loans.',
  render(container: HTMLElement) {
    ...
    const form = document.getElementById('appLoanForm') as HTMLFormElement;
