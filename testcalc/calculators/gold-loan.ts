 ...
 * Calculates EMI for a gold loan using the standard EMI formula:
 * EMI = [P * r * (1+r)^n] / [(1+r)^n - 1]
 * P = Principal, r = monthly interest rate, n = number of months
 */

export const goldLoanCalc = {
  id: 'gold-loan',
  name: 'Gold Loan Calculator',
  description: 'Calculate EMI for your gold loan.',
  render(container: HTMLElement) {
    ...
    const form = document.getElementById('goldLoanForm') as HTMLFormElement;
